...
$(document).ready(function(){
	...
	// var fh = new FrameHandler('temp',10000, {});
	$('#continuous').on('click', function(){
		chrome.storage.sync.set({'mode':'continuous'}, function(){console.log('Success saving as continuous.');});
	});

	$('#discrete').on('click', function(){
		chrome.storage.sync.set({'mode':'discrete'}, function(){console.log('Success saving as discrete.');});
	});
